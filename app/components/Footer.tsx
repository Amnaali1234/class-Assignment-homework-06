        ...
        <div className="w[1120px] h[82px] flex lg:flex-row flex-col items-start gap-3 justify-between">
          ...
          <div className="w-[400px] h[82px] flex flex-col gap-[16px] ">
            <div className="h-[48px] flex w-[400px] gap-[16px] ">
              <input
                className="h-[48px] w-[256px] border-solid border-black border-[1px] rounded-[5px] p-3 placeholder-[#505050]"
                placeholder="Enter your email"
                type="text"
              />
              <button className="w-[119px] h-[48px] text-[16px] leading-[24px] border-solid rounded-[5px] border-black border-[1px]">
                Subscribe
              </button>
            </div>
        ...
        <div className="w[1120px] h-[57px] items-end border-solid border-black border-t-[2px] pt-[33px]">
          <div className="h-[24px] flex justify-between">
            <div className="h-[21px] flex gap-[24px]">
              ...
              <Link className="text-[14px] leading-[21px] underline" href="">
                Privacy Policy
              </Link>
              <Link className="text-[14px] leading-[21px] underline" href="">
                Privacy Policy
            ...
            <div className="flex w-[132px] h-[24px] items-center ">
              ...
              <div className="h-[24px] w-[24px]  flex justify-center items-center mr-[12px]">
                <Image className="" src={instaLogo} alt="Insta Logo" />
              </div>
              <div className="h-[24px] w-[24px]  flex justify-center items-center mr-[12px]">
                <Image className="" src={twitterLogo} alt="Twitter Logo" />
              </div>
              <div className="h-[24px] w-[24px]  flex justify-center items-center ">
                <Image className="" src={linkedinLogo} alt="Linkedin Logo" />
              </div>
            </div>
          </div>
        </div>
